...
\end{equation*}
for an elastic body. Here $\rho$ is the referential density, $\boldsymbol{\varphi}$ the motion, and $\mathbf{T}$ the first Piola-Kirchhoff stress tensor. For an arbitrary sub-body, $U$, of the reference body, $M$, show that the equality
\begin{equation*}
...
The angular momentum of the sub-body $U$ is defined by
\begin{equation*}
