...
\label{eq:1}
\end{equation}
for all $\mathbf{x}$. There are circumstance in which it is useful to select a different reference body, but 
...
created nor destroyed. This means that the mass of this arbitrary sub-body is constant, and hence 
\begin{equation}
...
By analogy with particle mechanics, the \textbf{kinetic energy density} of the body per-unit volume within the reference body $M$ is defined as
\begin{equation}
...
\label{eq:33}
\end{equation}
hold within the body, while on $\partial M$ we also have the \textbf{natural boundary conditions}
\begin{equation}
...
is mostly used within fluid mechanics (including in the earlier parts of this course). In the next lecture, 
