...
\captionsetup{hypcap=false}% \captionof figures cannot carry hyperref anchors
...
% a problem set: same title treatment, its own label prefix, figures numbered within the set
\newcommand{\problemset}[2]{%
  \renewcommand{\lecprefix}{P#1}%
  \title{Problem Set #1}%
  \author{}%
  \maketitle
  \let\maketitle\lec@maketitle
...
% compact title block for each lecture (the class's version leaves an empty author line and large skips)
\def\@maketitle{%
  \cleardoublepage\null
  {\raggedright{\t@font\@title\par}}%
  \par\vskip 1em
}
\makeatother
...
\clearpage
\section*{Preface}
These notes cover the seismology part of the course, Lectures 13--24, and they will also be available on the 
Teaching Information System (TiS). The material is close to that of previous years, but the notes have been revised 
throughout and a number of figures added. Errors will surely remain: if you find one, however small, please email me 
at \texttt{da380@cam.ac.uk} and the version on the TiS will be updated. The two problem sets for this part of the course 
are included at the end of these notes, and their solutions are available on the TiS.
...
\problemset{1}{problem1_body}
\problemset{2}{problem2_body}
...
\section*{References}
\begingroup
\setlength{\parindent}{0pt}\setlength{\parskip}{2pt plus 1pt}
...
\refitem{Adourian, S., Dursun, M.~S., Lau, H.~C.~P. \& Al-Attar, D. (2024). Adjoint sensitivity kernels for free oscillation spectra. \emph{Geophysical Journal International} \textbf{238}, 257--271.}
\refitem{Akbarashrafi, F., Al-Attar, D., Deuss, A., Trampert, J. \& Valentine, A.~P. (2018). Exact free oscillation spectra, splitting functions and the resolvability of Earth's density structure. \emph{Geophysical Journal International} \textbf{213}, 58--76.}
\refitem{Al-Attar, D. \& Woodhouse, J.~H. (2008). Calculation of seismic displacement fields in self-gravitating earth models: applications of minors vectors and symplectic structure. \emph{Geophysical Journal International} \textbf{175}, 1176--1208.}
\refitem{Al-Attar, D., Woodhouse, J.~H. \& Deuss, A. (2012). Calculation of normal mode spectra in laterally heterogeneous earth models using an iterative direct solution method. \emph{Geophysical Journal International} \textbf{189}, 1038--1046.}
...
\refitem{Gutenberg, B. (1914). \"{U}ber Erdbebenwellen. VIIA. Beobachtungen an Registrierungen von Fernbeben in G\"{o}ttingen und Folgerungen \"{u}ber die Konstitution des Erdk\"{o}rpers. \emph{Nachrichten von der Gesellschaft der Wissenschaften zu G\"{o}ttingen, Mathematisch-Physikalische Klasse} \textbf{1914}, 166--218.}
...
\refitem{Lichtenstein, L. (1918). \"{U}ber einige Eigenschaften der Gleichgewichtsfiguren rotierender Fl\"{u}ssigkeiten, deren Teilchen einander nach dem Newtonschen Gesetze anziehen. \emph{Sitzungsberichte der Preussischen Akademie der Wissenschaften}, 1120--1135.}
\refitem{Lichtenstein, L. (1933). \emph{Gleichgewichtsfiguren rotierender Fl\"{u}ssigkeiten}. Springer.}
...
\refitem{Ortiz, J.~L. et al.\ (2017). The size, shape, density and ring of the dwarf planet Haumea from a stellar occultation. \emph{Nature} \textbf{550}, 219--223.}
\refitem{Poincar\'{e}, H. (1885). Sur l'\'{e}quilibre d'une masse fluide anim\'{e}e d'un mouvement de rotation. \emph{Acta Mathematica} \textbf{7}, 259--380.}
...
\refitem{Ritsema, J., Deuss, A., van Heijst, H.-J. \& Woodhouse, J.~H. (2011). S40RTS: a degree-40 shear-velocity model for the mantle from new Rayleigh wave dispersion, teleseismic traveltime and normal-mode splitting function measurements. \emph{Geophysical Journal International} \textbf{184}, 1223--1236.}
...
\refitem{Woodhouse, J.~H. (1988). The calculation of eigenfrequencies and eigenfunctions of the free oscillations of the Earth and the Sun. In \emph{Seismological Algorithms} (ed. D.~J. Doornbos), pp. 321--370. Academic Press, London.}
