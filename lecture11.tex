...
\begin{equation}
\gamma_{i}^{1}=-G\int_{M}\rho'\left(\frac{\delta_{ij}}{[(x_{k}-x_{k}')(x_{k}-x_{k}')]^{3/2}}-\frac{3(x_{i}-x_{i}')(x_{j}-x_{j}')}{[(x_{k}-x_{k}')(x_{k}-x_{k}')]^{5/2}}\right)(u_{j}-u_{j}')\dd\mathbf{x}',
\end{equation}
...
\begin{equation}
\int_{M}\left[\rho\left(\frac{\partial^{2}u_{i}}{\partial t^{2}}+2\epsilon_{ijk}\Omega_{j}\frac{\partial u_{k}}{\partial t}+\epsilon_{ijk}\epsilon_{klm}\Omega_{j}\Omega_{l}u_{m}\right)-\frac{\partial}{\partial x_{j}}(A_{ijkl}\frac{\partial u_{k}}{\partial x_{l}}-\overline{S}_{ij})-\rho\gamma_{i}^{1}\right]w_{i}^{*}\dd\mathbf{x}=0.
\end{equation}
...
\begin{equation}
\int_{M}\left[\rho\left(\frac{\partial^{2}u_{i}}{\partial t^{2}}+2\epsilon_{ijk}\Omega_{j}\frac{\partial u_{k}}{\partial t}+\epsilon_{ijk}\epsilon_{klm}\Omega_{j}\Omega_{l}u_{m}-\gamma_{i}^{1}\right)w_{i}^{*}+(A_{ijkl}\frac{\partial u_{k}}{\partial x_{l}}-\overline{S}_{ij})\frac{\partial w_{i}^{*}}{\partial x_{j}}\right]\dd\mathbf{x}=0.
\end{equation}
...
\begin{equation}
\langle \mathbf{w}|P|\mathbf{u}\rangle=\int_{M}\rho w_{i}^{*}u_{i}\dd\mathbf{x},
\end{equation}
...
\begin{equation}
\langle \mathbf{w}|W|\mathbf{u}\rangle=\int_{M}2\rho\epsilon_{ijk}w_{i}^{*}\Omega_{j}u_{k}\dd\mathbf{x}
\end{equation}
...
\begin{equation}
\langle \mathbf{w}|H|\mathbf{u}\rangle=\int_{M}\left(\rho\epsilon_{ijk}\epsilon_{klm}w_{i}^{*}\Omega_{j}\Omega_{l}u_{m}+A_{ijkl}\frac{\partial w_{i}^{*}}{\partial x_{j}}\frac{\partial u_{k}}{\partial x_{l}}-\rho w_{i}^{*}\gamma_{i}^{1}\right)\dd\mathbf{x},
\end{equation}
and write the force term as
\begin{equation}
\langle \mathbf{w}|\mathbf{f}\rangle=\int_{M}\overline{S}_{ij}\frac{\partial w_{i}^{*}}{\partial x_{j}}\dd\mathbf{x}.
\end{equation}
...
\begin{equation}
\langle \mathbf{w}|W|\mathbf{u}\rangle=\int_{M}2\rho\epsilon_{ijk}w_{i}^{*}\Omega_{j}u_{k}\dd\mathbf{x} = -\left(\int_{M}2\rho\epsilon_{ijk}u_{i}^{*}\Omega_{j}w_{k}\dd\mathbf{x}\right)^{*} = -\langle \mathbf{u}|W|\mathbf{w}\rangle^{*},
\end{equation}
...
\begin{equation}
\int_{M}\rho\epsilon_{ijk}\epsilon_{klm}w_{i}^{*}\Omega_{j}\Omega_{l}u_{m}\dd\mathbf{x}=\left(\int_{M}\rho\epsilon_{ijk}\epsilon_{klm}w_{i}\Omega_{j}\Omega_{l}u_{m}^{*}\dd\mathbf{x}\right)^{*} = \left(\int_{M}\rho\epsilon_{ijk}\epsilon_{klm}u_{i}^{*}\Omega_{j}\Omega_{l}w_{m}\dd\mathbf{x}\right)^{*},
\end{equation}
...
\begin{equation}
\int\rho w_{i}^{*}\gamma_{i}^{1}(\mathbf{u})\dd\mathbf{x}=\int\rho\gamma_{i}^{1}(\mathbf{w})^{*}u_{i}\dd\mathbf{x}.
\end{equation}
...
\begin{equation}
\langle \mathbf{u}|H|\mathbf{u}\rangle=\int_{M}A_{ijkl}\frac{\partial u_{i}^{*}}{\partial x_{j}}\frac{\partial u_{k}}{\partial x_{l}}\dd\mathbf{x},
\end{equation}
...
\begin{equation}
\langle \mathbf{u}|H|\mathbf{u}\rangle=\frac{1}{4}\int_{M}A_{ijkl}\left(\frac{\partial u_{i}}{\partial x_{j}}+\frac{\partial u_{j}}{\partial x_{i}}\right)^{*}\left(\frac{\partial u_{k}}{\partial x_{l}}+\frac{\partial u_{l}}{\partial x_{k}}\right)\dd\mathbf{x},
\end{equation}
...
\begin{equation}
\langle \mathbf{u}|H|\mathbf{u}\rangle=\frac{1}{4}\int_{M}A_{ijkl}\left(\frac{\partial u_{i}}{\partial x_{j}}+\frac{\partial u_{j}}{\partial x_{i}}\right)^{*}\left(\frac{\partial u_{k}}{\partial x_{l}}+\frac{\partial u_{l}}{\partial x_{k}}\right)\dd\mathbf{x}>0,
\end{equation}
