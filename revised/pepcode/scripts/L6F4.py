...
LABELS = {"P": (70, 8, -10), "PcP": (30, 0, 6), "PP": (130, -10, 8), "PKP": (160, 0, 8), "PKiKP": (70, 0, 6),
          "PKIKP": (140, 0, -11), "S": (60, -12, 4), "ScS": (30, 0, 6), "SS": (120, -12, 6), "SKS": (100, 6, -11),
          "SKKS": (150, 0, 7), "SKIKS": (165, 0, -11)}
...
for phases, col in [(P_PHASES, "tab:red"), (S_PHASES, "k")]:
    for ph in phases:
        ...
        ax.annotate(ph, (d[i], t[i] / 60), xytext=(dx, dy), textcoords="offset points", color=col, fontsize=8, ha="center")
