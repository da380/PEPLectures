...
\begin{enumerate}
    ...
    \label{eq:20}
    \end{equation}
    Again, the necessity of this condition can also be proven. Setting $\mathbf{Q}(t)=\mathbf{1}$, this identity reduces to
    \begin{equation}
...
\label{eq:27}
\end{equation}
vanish for all smooth variations $\delta\bphi$ satisfying eq.~(\ref{eq:26}). The first variation depends linearly on 
