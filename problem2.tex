...
Here we suppose that the data has been processed such that the components of $\mathbf{e}$ are uncorrelated and have unit standard deviations (this corresponds to the data covariance, $\mathbf{C}$, being the $n\times n$ identity matrix).
